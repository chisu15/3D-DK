...
namespace hieucontroller
{
    ...
    public class PlayerController : NetworkBehaviour
    {
        ...
        [Header("Base Movement")] public float runAcceleration = 35f;
        ...
        [Header("Animation")] public float playerModelRotationSpeed = 10f;
        public float rotateToTargetTime = 0.67f;

        [Header("Camera Settings")] public float lookSenseH = 0.1f;
